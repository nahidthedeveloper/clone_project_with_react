...
export default function Hero() {
    ...
    useGSAP(() => {
        ...
        tl.from(overlayImageRef.current.querySelector('image'), {
            opacity: 0,
            scale: 1.5,
            duration: 0.8,
        }, 'a');
    ...
    return (
        <div className="relative">
            ...
            <div
                ref={overlayImageRef}
                className="hidden md:block h-[60vw] lg:h-[120vh] w-[46.5vw] absolute right-[-3%] top-[-40%] overflow-hidden"
                style={{zIndex: 1}}
            >
                <div className="relative w-full h-full">
                    <div className="overlay absolute left-0 top-0 w-full h-full bg-dark noise"/>
                    <img
                        className="right-0 h-full w-full object-cover object-top"
                        src={"images/about/men.jpg"}
                        alt="Men"
                    />
                </div>
